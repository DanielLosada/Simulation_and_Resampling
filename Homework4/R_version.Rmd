...
# 1. Simulate ARMA(1,1) data (as you already have)
set.seed(123)
n <- 1200
ar.param <- 0.6
ma.param <- -0.5
sim_data <- arima.sim(n=n, list(ar=ar.param, ma=ma.param))

# 2. Fit ARMA(1,1) model to original data
model <- arima(sim_data, order=c(1,0,1))
...
# 3. Loop over R bootstrap replications
R <- 1000
...
# 4. Compute standard errors as SD across all replications
